async function initializeContentPage() {
    ...
    getProducts();
    getCartItems();
    document.getElementById('welcome').innerHTML = 'WELCOME ' + sessionStorage.getItem('username').toUpperCase();
...
function createRowForCartItem(item) {
